@scenarios @AISM39 @AccessManagement
Feature: AISM-39
  As an Administrator
  ...
  Scenario: Verify editting a User
    When I click Maintenance tab
    And I select Access Management
    And I click the user with name: AUT_TestUser
  ...
  Scenario: Verify that From date cannot be greater than To date when setting Expiration date for User
    When I click Maintenance tab
    And I select Access Management
    And I click the user with name: AUT_TestEdittedUser
  ...
  Scenario: Verify deleting a User
    When I click Maintenance tab
    And I select Access Management
    And I click the delete button of user AUT_TestEdittedUser
